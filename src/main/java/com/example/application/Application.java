...
public class Application implements AppShellConfigurator {
    ...
    public static void initilizeData(){
        ...
        listingDataBase.add(new Listing(userDataBase.get("dougdimmadome"), "8/22/2023", 0, "Tall Hat Class",
        ...
        listingDataBase.add(new Listing(userDataBase.get("peterbuckley"), "8/22/2023", 0, "Fly Tieing Class", 
        "In this cource we will cover the basic fly tieing materials and processes. You will also learn how to tie your very own frenchie nymph! ", "Outdoors",
