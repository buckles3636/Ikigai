...
public class Application implements AppShellConfigurator {
    ...
    public static HashSet<Listing> listingDataBase;
    ...
    public static void initilizeData(){
        ...
        listingDataBase.add(new Listing(userDataBase.get("dougdimmadome"), "8/22/2023 2:00am", 0, "Tall Hat Class",
         "Have you ever wanted to be cool? Well now you can by properly learning how to wear a tall hat!", "Style",
        ...
        listingDataBase.add(new Listing(userDataBase.get("peterbuckley"), "8/15/2023 3:00pm", 0, "Fly Tying Class", 
        "Learn about basic fly tying materials/processes and tie your very own frenchie nymph! ", "Outdoors",
        ...
        listingDataBase.add(new Listing(userDataBase.get("seaneisenstein"), "8/19/2023 4:30pm", 0, "Ski / Board Waxing Class", 
        "In this course we will explore the simple process of waxing your own skis or snowboard.", "Outdoors",
        "https://static.evo.com/content/cms/guides/ski/ski%20wax.jpg"
         ));

        listingDataBase.add(new Listing(userDataBase.get("tyleradams"), "8/20/2023 2:30pm", 0, "Wine Pairing Class", 
        "In this course we will learn how to bring out the complexities of flavor in wine through food.", "Food",
        "https://www.winetourism.com/files/2022/10/food_and_wine_pairing_2_-1170x334.webp?1670937402"
         ));

        listingDataBase.add(new Listing(userDataBase.get("cartercroke"), "8/17/2023 4:00pm", 0, "Music Mixing Class", 
        "Learn the tools and software necessary to become a DJ. Additionally, we will cover beat matching and basic techniques of mixing.", "Music",
        ...
        listingDataBase.add(new Listing(userDataBase.get("jackyounger"), "8/30/2023 2:00pm", 0, "Piano Basics", 
        "We tackle the basics of the keyboard, some of the theory behind your favorite songs' melodies, major and minor keys and chords, and at the conclusion you will know how to play viva la vida by Coldplay.", "Music",
        "https://www.musicnotes.com/images2/promos/store/900x520_piano-min.jpg"
         ));

        listingDataBase.add(new Listing(userDataBase.get("jameszieper"), "8/25/2023 3:00pm", 0, "Chess Stratagy", 
