...
public class Application implements AppShellConfigurator {
    ...
    public static void initilizeData(){
        ...
        new String[] {"Phesant Tail", "Bobbin", "Vise", "Thread", "Tungston Beads", "Brass Wire"}, 120,
        ...
        "In this course we will explore the simple process of waxing your own skis or snowboard.", "Outdoors", false, true,
        new String[] {"All-temperature ski wax", "waxing iron", "plastic scraper", "base cleaner", "cork block", "nylon brush"}, 20,
        ...
        "In this course we will learn how to bring out the complexities of flavor in wine through food.", "Food", true, false,
        new String[] {"3 small bottles of wine", "cheeses", "fruit", "bread"}, 24,
        ...
        "Learn the tools and software necessary to become a DJ. Additionally, we will cover beat matching and basic techniques of mixing.", "Music", false, true,
        new String[] {"Mixing board", "Speakers", "Headphones"}, 0,
        ...
        "We tackle the basics of the keyboard, some of the theory behind your favorite songs' melodies, major and minor keys and chords, and at the conclusion you will know how to play viva la vida by Coldplay.", "Music", false, true,
        new String[] {"A piano, keyboard, piano app"}, 0,
